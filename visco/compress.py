    ...
    if decorrelation is not None:
        ...
        for bli in vis_data:
            ...
            for corr in correlation.split(','):
                ...
                total_data_size += baseline_data_volume
        ...
        if not zarr_output_path:
            zarr_output_path = os.path.join(os.getcwd(), "output_data", "compressed_visdata.zarr")
        ...
        log.info(f"Visibility data has been compressed in column {column}"
