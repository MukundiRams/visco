...
def get_logger(name, level="DEBUG"):
    ...
    logging.basicConfig(
        level=logging.DEBUG, format=format_string, datefmt="%m:%d %H:%M:%S"
    )
...
BIN = OmegaConf.create(
    {"visco": "visco", "compressms": "compressms", "decompressms": "decompressms"}
)
    ...
    if host_addr is not None:
        ...
        try:
            ...
            print(
                ...
                getattr(cluster, "dashboard_address", None),
            )
